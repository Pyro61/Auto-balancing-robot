...
set(CORE_FLAGS "-mcpu=cortex-m0plus -mfloat-abi=soft -mthumb")
...
set(CXX_FLAGS "-std=c++11 -ffunction-sections -fdata-sections -fno-rtti -fno-exceptions -fverbose-asm -MMD")
...
# fverbose-asm - additional comments for generated assembler code
# -MMD - create dependency files
set(C_FLAGS "-std=c11 -ffunction-sections -fdata-sections -fverbose-asm -MMD")
...
set(LD_SCRIPT ${CMAKE_SOURCE_DIR}/STM32C031C6TX_FLASH.ld)
# Linker flags
...
set(LD_FLAGS "-Wl,-Map=${CMAKE_BINARY_DIR}/${CMAKE_PROJECT_NAME}.map,--cref -T\"${LD_SCRIPT}\" -g -Wl,--gc-sections")
